...
public class OyunEkrani extends SurfaceView implements Runnable {
    ...
    public OyunEkrani(OyunActivity activity, int ekranX, int ekranY){
        ...
        prefs = activity.getSharedPreferences("oyun", activity.MODE_PRIVATE);
        ...
        sound = soundPool.load(activity, R.raw.atesses, 1);
    ...
    private void update(){
        ...
        for (Kus kus : kuslar){
            ...
            if (kus.x + 200 < 0){
                ...
                kus.x = ekranX;
                kus.y = rastgele.nextInt(ekranY-173);
